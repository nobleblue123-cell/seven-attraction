      ...
      >
        {seconds > 0 ? (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10 }}>
            ...
            <div style={{
              width: 200, height: 3,
              background: 'rgba(255,255,255,.08)', borderRadius: 100, overflow: 'hidden',
            }}>
              <motion.div
                initial={{ width: '100%' }}
                animate={{ width: `${(seconds / TOTAL) * 100}%` }}
                transition={{ duration: 1, ease: 'linear' }}
                style={{ height: '100%', background: 'linear-gradient(90deg,#7c3aed,#ec4899)', borderRadius: 100 }}
              />
            </div>
          </div>
        ) : null}
